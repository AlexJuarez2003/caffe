...
const AdminDashboard = () => {
    ...
    if (vistaActual === "personal") {
      ...
      fetchWithAuth("http://localhost:8000/accounts/chefs/")
        ...
        .catch(() =>
          notify({
            type: "error",
            title: "Error al cargar cocineros",
            duration: 3000,
          }),
        );
  ...
  return (
    <div
      className="flex min-h-screen bg-[#F4F3ED]"
    ...
    >
      <div className="w-64 bg-[#2D3A22] text-white p-6 flex flex-col justify-between shadow-xl">
        ...
        <div className="text-[10px] text-gray-400 font-bold flex justify-center uppercase tracking-wide">
          <button
      ...
      <div className="flex-1 p-10">
        ...
        {vistaActual === "ventas" && <VentasPanel />}
        {vistaActual === "pedidos" && (
          <PedidosAdmin
            pedidos={pedidos}
            ...
            <div className="flex justify-between items-center mb-8">
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">
                  Administra cocineros y repartidores.
                </p>
              </div>
              <button
                  ...
                  <tbody className="divide-y divide-gray-50">
                    ...
                    {cocineros.length === 0 && (
                      <tr>
                        <td
                          colSpan={6}
                          className="py-10 text-center text-gray-300 font-black text-sm uppercase tracking-widest"
                        >
